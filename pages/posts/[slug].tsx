    ...
    <main>
      ...
      {submitted ? (
        <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
          ...
          <p>Once it approved, it will be appear below.</p>
        </div>
      ) : (
      <form className="flex flex-col p-5 max-w-2xl my-10 mx-auto mb-10" onSubmit={handleSubmit(onSubmit)}>
        ...
        />
            ...
            {/* errors will return when field validation failes*/}
